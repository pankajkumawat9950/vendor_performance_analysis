...
3. Install Python packages: `pandas`, `numpy`, `matplotlib`, `seaborn`, etc.  
4. Follow cells in the notebook to reproduce the analysis  
5. Open Power BI file to explore interactive dashboards

## 📌 Outcome
- Clear vendor performance insights  
- Visual dashboards for business use  
